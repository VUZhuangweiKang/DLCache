...
def main_worker(gpu, ngpus_per_node, args):
    ...
    t = time.time()
    val_dataset = cifar100Dataset(keys=['Imagenet-Mini-Obj/val'], transform=transform)
    ...
    if args.evaluate:
        ...
        train_dataset = cifar100Dataset(keys=['Imagenet-Mini-Obj/val'], transform=transform)  # for test only
        if args.distributed:

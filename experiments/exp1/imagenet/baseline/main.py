...
def main_worker(gpu, ngpus_per_node, args):
    ...
    #     return
    # else:
    train_dataset = ImageDataset(manifest_path='manifest.csv', transform=transform)
    if args.distributed:
...
def validate(val_loader, model, criterion, args):
    ...
    num_batches = math.ceil(len(val_loader.dataset) / val_loader.batch_size)
    progress = ProgressMeter(
        num_batches + (args.distributed and (len(val_loader.sampler) * args.world_size < len(val_loader.dataset))),

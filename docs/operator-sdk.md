...
# create an operator
```shell
operator-sdk init dlcpod-operator --repo=github.com/VUZhuangweiKang/DLCache/tree/main/dlcpod-operator
operator-sdk create api --group docgroup.com --version=v1alpha1 --kind=DLCPod --resource=true --controller=true

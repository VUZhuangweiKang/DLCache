...
// DLCPodSpec defines the desired state of DLCPod
type DLCPodSpec struct {
...
// DLCPod is the Schema for the dlcpods API
type DLCPod struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   DLCPodSpec   `json:"spec,omitempty"`
	Status DLCPodStatus `json:"status,omitempty"`
}

//+kubebuilder:object:root=true

// DLCPodList contains a list of DLCPod
type DLCPodList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []DLCPod `json:"items"`
}

func init() {
	SchemeBuilder.Register(&DLCPod{}, &DLCPodList{})
}
